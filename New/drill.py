...
class Drill():
    ...
    _num_frames_to_average = 10
    _dete_area = 20
    _pixel_precentage = 15
    _max_count = 1
    _length_threshould = 4
    ...
    ########################             Image processing       #############################
    #########################################################################################
    def _get_average_frame(self, num_frames_to_average):
    ...
    def _get_the_lase_contour(self, mask_1, mask_2):
        #final mask
        ...
        while True:
            for angle in anglesList:
                ...
                while True:
                    ...
                    ret, frame = self._get_average_frame(3)
                    if not ret:
                        return
                    ...
                    if percentage_change > self._pixel_precentage:
                        ...
                        contour_area, laser_contour = self._get_the_lase_contour(red_mask, white_mask)
